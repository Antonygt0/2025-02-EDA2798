...
public class Loans {
    ...
    public Loans(String accountNumber, LocalDate date, String type, BigDecimal totalLoan, BigDecimal amountPaid,
    ...
    public String toString() {
        return "Loans [accountNumber=" + accountNumber + ", date=" + date + ", type=" + type + ", totalLoan="
                + totalLoan + ", amountPaid=" + amountPaid + ", outstandingAmt=" + outstandingAmt + "]";
    }
